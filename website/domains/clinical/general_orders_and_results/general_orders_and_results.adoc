...
xref:technical_specs/O19.adoc[Message - O19 General Clinical Order]

xref:technical_specs/O51.adoc[Message - O51 Order Status Update]

xref:technical_specs/O57.adoc[Message - O57 General Clinical Order with Supporting Document]

xref:technical_specs/R01.adoc[Message - R01 Unsolicited Observation]

xref:technical_specs/R30.adoc[Message - R30 Unsolicited Point-Of-Care Observation without Existing Order - R30 Place an Order]

xref:technical_specs/R31.adoc[Message - R31 Unsolicited New Point-Of-Care Observation - R31 Search for an Order]

xref:technical_specs/R32.adoc[Message - R32 Unsolicited Pre-Ordered Point-Of-Care Observation]

xref:technical_specs/R40.adoc[Message - R40 Unsolicited Alert Observation]

xref:technical_specs/R42.adoc[Message - R42 Unsolicited Device Event Observation]

xref:technical_specs/R43.adoc[Message - R43 Unsolicited Patient-Device Association Observation]
