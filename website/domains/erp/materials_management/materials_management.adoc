...
This Materials Management topic defines abstract messages for the purpose of communicating various events related to the transactions derived from supply chain management within a healthcare facility. There are two basic types of messages defined: _inventory item master file updates, and supply item sterilization messages_.
...
This topic defines trigger events used to communicate supply item information between applications.
